...
{
    const char* pszTimestamp = "PSH PSH 2CHCOIN TI SNOVA VIHODISH NA SVYAZ? 20/04/01";
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 52560; // Note: actual number of blocks per calendar year with DGW v3 is ~200700 (for example 449750 - 249050)
        ...
        consensus.nMasternodePaymentsIncreasePeriod = 1; // 17280 - actual historical value
        ...
        consensus.BIP34Hash = uint256S("0x00211268bceca33749ae3561669c18eb54a9487b1e8e0adf187cbbcefd044584");
        ...
        consensus.DIP0003EnforcementHash = uint256S("00211268bceca33749ae3561669c18eb54a9487b1e8e0adf187cbbcefd044584");
        consensus.powLimit = uint256S("007fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        ...
        genesis = CreateGenesisBlock(1585186543, 924, 0x1f7fffff, 1, 50 * COIN);
        //MineGenesis(genesis, consensus.powLimit, true);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00211268bceca33749ae3561669c18eb54a9487b1e8e0adf187cbbcefd044584"));
        assert(genesis.hashMerkleRoot == uint256S("0x629674b2723d115bd5c0e930817b37e019ccb4366dda058fb8c4f1b7ed4702d2"));
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1585180039UL, 158UL, 0x1e3fffff, 1, 50 * COIN);
        //MineGenesis(genesis, consensus.powLimit, true);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00488bc71ef4c157af0db253f778443df175356a7c74514473617e8a4c7d7950"));
        assert(genesis.hashMerkleRoot == uint256S("0x629674b2723d115bd5c0e930817b37e019ccb4366dda058fb8c4f1b7ed4702d2"));
...
public:
    CDevNetParams() {
        ...
        genesis = CreateGenesisBlock(1585190776, 0, 0x207fffff, 1, 50 * COIN);
        //MineGenesis(genesis, consensus.powLimit, true);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x598a76cfc11e1af5b0dd8c6cd211a6d93531426dde8ce9344fb4cc1bfa326e8c"));
        assert(genesis.hashMerkleRoot == uint256S("0x629674b2723d115bd5c0e930817b37e019ccb4366dda058fb8c4f1b7ed4702d2"));
